...
import type { EncounterMap, StatSet } from "@/lib/dex";
import type { EffectivenessBucket, TypeName } from "@/lib/types";
...
/** A display-ready form: resolved image URLs + precomputed effectiveness. */
...
interface Props {
  ...
  /** Evolution chain, independent of the selected variant. */
  evolution: ReactNode;
}

/**
 * Hero + effectiveness with variant switching:
